$(document).ready(function () {
  ...
  $(".service-card-details-link").click(function () {
    ...
    $this
      ...
      .siblings()
      .children(".service-card-details-block")
      .hide();
    var $otherDetailLinks = $this
      .parents(".service-card")
      .siblings()
      .children()
      .children(".service-card-details-link");
    ...
    var $detailsContent = $this
      .parents()
      .nextAll(".service-card-details-block")
      .first();
  ...
  elems.on("mouseenter mouseleave", function (e) {
    elems
      .not(this)
      .stop(true)
      .fadeTo("fast", e.type == "mouseenter" ? 0.5 : 1);
  });
});
